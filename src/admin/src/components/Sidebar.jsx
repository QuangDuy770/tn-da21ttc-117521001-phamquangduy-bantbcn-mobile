    ...
    <div className='w-[18%] min-h-screen border-r-2'>
      ...
      <NavLink className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l" to={"/tq"}>
        ...
        <NavLink className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l" to={"/list"}>
            <img className='w-8 h-8' src={assets.list_icon} alt="" />
            <p className='hidden md:block'>Danh sách <br />sản phẩm</p>
        </NavLink>
        ...
        <NavLink className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l" to={"/orders"}>
         ...
         <NavLink className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l" to={"/rating"}>
            <img className='w-8 h-8' src={assets.chat_icon} alt="" />
            <p className='hidden md:block'>Sản phẩm <br />đánh giá</p>
        </NavLink>
      </div>
    </div>
  )
